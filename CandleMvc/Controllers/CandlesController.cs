...
namespace CandleMvc.Controllers
{
    public class CandlesController : Controller
    {
        ...
        public CandlesController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Material,Length,Origin,Color,Price")] Candle candle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Material,Length,Origin,Color,Price")] Candle candle)
        {
            if (id != candle.Id)
            {
                return NotFound();
